    ...
    return html`
        <div class="recent-project-section">
            ...
            <div class="controls-slider">
                <button class="button-control prev-btn"><i class="fa-solid fa-arrow-left"></i>Prev</button>
                <button class="button-control next-btn">Next<i class="fa-solid fa-arrow-right"></i></button>
            </div>
        </div>
